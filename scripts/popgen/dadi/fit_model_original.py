...
datafile = '../data_prep/mpusilla.snps.4d.notMT.nomissing.vcf.gz' 
...
def fit_and_print ( fs ) :
    ...
    try:
      fid = open('model_fits.4d.original_corrected.txt','a')
    except:
      fid = open('model_fits.4d.original_corrected.txt','w')
